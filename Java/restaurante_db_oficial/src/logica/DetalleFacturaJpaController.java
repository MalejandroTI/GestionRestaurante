...
public class DetalleFacturaJpaController implements Serializable {
    ...
    public void create(DetalleFactura detalleFactura) {
        ...
        try {
            ...
            if (idProducto != null) {
                idProducto.getDetalleFacturaCollection().add(detalleFactura);
    ...
    public void edit(DetalleFactura detalleFactura) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getDetalleFacturaCollection().remove(detalleFactura);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getDetalleFacturaCollection().add(detalleFactura);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = detalleFactura.getIdProducto();
            if (idProducto != null) {
                idProducto.getDetalleFacturaCollection().remove(detalleFactura);
                idProducto = em.merge(idProducto);
            }
